...
const BackgroundButton = ({ text, image = null, bgColor, onClick, wWidth = "w-auto", wSizing = "w-10", hSizing = "h-10", flip = false}) => {
    ...
    if (image && text) {
      if (flip) {
        return (
          <button onClick={onClick} className={`relative inline-flex items-center justify-center ${wWidth} h-10 ${bgClass} ${hoverClass} text-white text-lg font-semibold rounded-full background-shadow background-hover`}>
        ...
        return (
            <button onClick={onClick} className={`relative inline-flex items-center justify-center h-10 ${wWidth} ${bgClass} ${hoverClass} text-white text-lg font-semibold rounded-full background-shadow background-hover`}>
