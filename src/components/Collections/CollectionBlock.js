            ...
            {isExpanded && (
                ...
                >
                    ...
                    >
                        ...
                        {/* Grid for subjects */}
                        <div className="flex flex-col overflow-y-auto h-[calc(100%-4rem)] sm:h-[calc(100%-4rem)] sm:grid sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 2xl:grid-rows-3 p-4 gap-4">
